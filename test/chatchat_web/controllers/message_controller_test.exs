defmodule ChatchatWeb.MessageControllerTest do
  use ChatchatWeb.ConnCase

  alias Chatchat.SavedChat

  @create_attrs %{date: "2010-04-17T14:00:00Z", msg: "some msg", name: "some name", room_id: 42, user_id: 42}
  ...
  def fixture(:message) do
    {:ok, message} = SavedChat.create_message(@create_attrs)
    message
  end
