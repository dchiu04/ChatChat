defmodule Chatchat.ChatsTest do
  use Chatchat.DataCase

  alias Chatchat.Chats
  ...
  describe "messages" do
    ...
    @valid_attrs %{body: "some body", date: "some date", name: "some name", room: "some room"}
    @update_attrs %{body: "some updated body", date: "some updated date", name: "some updated name", room: "some updated room"}
    @invalid_attrs %{body: nil, date: nil, name: nil, room: nil}
    ...
    test "update_message/2 with valid data updates the message" do
      ...
      assert {:ok, %Message{} = message} = Chats.update_message(message, @update_attrs)
      assert message.body == "some updated body"
      assert message.date == "some updated date"
      assert message.name == "some updated name"
      assert message.room == "some updated room"
    end
